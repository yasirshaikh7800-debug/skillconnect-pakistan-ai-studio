        ...
        <div className="max-w-md mx-auto space-y-6">
          <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-red-200 dark:border-red-900/50 shadow-2xl space-y-6 text-center">
            ...
            <form onSubmit={handleAdminLogin} className="space-y-4 text-left">
              ...
              <button
                type="submit"
                className="w-full py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold text-xs shadow-lg shadow-red-600/20 transition-all flex items-center justify-center space-x-2"
              >
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2">
              ...
              <p className="text-[11px] text-amber-600 font-semibold">Priority SLA: Under 2 hours</p>
            </div>
          </div>
