      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:py-24 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 max-w-md mx-auto">
            ...
            <code className="px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-blue-600 dark:text-blue-400 font-mono text-xs">
              {resolvedId || 'unknown'}
            </code>
        ...
        <div className="pt-4 flex items-center justify-center gap-4">
          ...
          <Link
            href="/"
            className="px-6 py-3 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 font-bold text-sm transition-all"
          >
            Go to Home
          </Link>
        </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <nav aria-label="Breadcrumb" className="flex items-center space-x-2 text-xs font-medium text-slate-500 dark:text-slate-400">
        ...
        <div className="flex items-center space-x-3">
          <button
            onClick={handleShare}
            className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer"
          >
            {copiedLink ? (
              <>
                <Check className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" />
                <span className="text-blue-600 dark:text-blue-400">Link Copied!</span>
              </>
            ) : (
              <>
          ...
          <Link
            href="/services"
            className="inline-flex items-center space-x-1.5 px-3.5 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-xs font-bold text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          {/* Header Card */}
          <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-8 space-y-6 shadow-xl">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <span className="text-xs uppercase font-extrabold px-3 py-1 rounded-lg bg-blue-600/10 border border-blue-600/30 text-blue-600 dark:text-blue-400">
                {service.category.name}
              </span>
              <div className="flex items-center space-x-2 text-xs font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/50 px-3 py-1 rounded-full border border-blue-600/20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-xs">
              <div className="flex items-center space-x-3 p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60">
                ...
                <div>
                  ...
                  <p className="font-bold text-slate-900 dark:text-white">~{service.durationMinutes} Minutes</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60">
                ...
                <div>
                  ...
                  <p className="font-bold text-slate-900 dark:text-white">{providerCity} & Surroundings</p>
                </div>
              </div>

              <div className="col-span-2 sm:col-span-1 flex items-center space-x-3 p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60">
                <ShieldCheck className="w-5 h-5 text-blue-600 dark:text-blue-400 shrink-0" />
                <div>
                  <p className="text-[10px] text-slate-400">Verification</p>
                  <p className="font-bold text-blue-600 dark:text-blue-400">NADRA CNIC Verified</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-8 space-y-6 shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-blue-600/10 text-blue-600 dark:text-blue-400 border border-blue-600/20">
                Top Rated
              </span>
            </div>

            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800">
              ...
              <div className="flex sm:flex-col items-center sm:items-end justify-between w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-t-0 border-slate-200 dark:border-slate-700">
        ...
        <div className="space-y-6">
          <div className="sticky top-24 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-8 space-y-6 shadow-2xl">
            <div className="space-y-2">
              ...
              <div className="flex items-baseline space-x-2">
                ...
                <span className="text-xs text-slate-400 dark:text-slate-500 font-medium">/ job estimate</span>
              </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-2xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 font-bold text-xs transition-all cursor-pointer"
              >
                Quick Booking Modal
              </button>
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3 text-xs text-slate-500 dark:text-slate-400">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-slate-900 dark:text-white">COD, JazzCash, EasyPaisa</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Confirmation</span>
                <span className="font-semibold text-slate-900 dark:text-white">Instant SMS & SCPK Code</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Cancellation</span>
                <span className="font-semibold text-blue-600 dark:text-blue-400">Free before dispatch</span>
              </div>
            </div>

            {/* Need Help Phone CTA */}
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 flex items-center space-x-3">
              ...
              <div className="text-xs">
                <p className="font-bold text-slate-900 dark:text-white">Need help booking?</p>
                <p className="text-[11px] text-slate-500 dark:text-slate-400">UAN Helpline: 0800-SKILL (PK)</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl relative">
            ...
            {confirmedBookingCode ? (
              <div className="text-center py-6 space-y-4">
                <div className="w-16 h-16 rounded-full bg-blue-600/10 text-blue-600 dark:text-blue-400 flex items-center justify-center mx-auto">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 space-y-1 font-mono text-xs">
                ...
                <div className="pt-2 flex items-center justify-center gap-3">
                  <Link
                    ...
                    className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs text-center"
                  >
              ...
              <form onSubmit={handleConfirmQuickBooking} className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    Total Estimated Fee: <strong className="text-slate-900 dark:text-white">PKR {service.basePrice.toLocaleString()}</strong>
                  </p>
                </div>
                ...
                <div className="space-y-3 text-xs">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600"
                    >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600"
                      >
                        <option className="dark:bg-slate-900">10:00 AM - 01:00 PM</option>
                        <option className="dark:bg-slate-900">02:00 PM - 05:00 PM</option>
                        <option className="dark:bg-slate-900">05:00 PM - 08:00 PM</option>
                      </select>
                    </div>
                  </div>
                ...
                <div className="pt-2 flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 text-xs font-semibold cursor-pointer"
                  >
                    Cancel
                  </button>
                </div>
