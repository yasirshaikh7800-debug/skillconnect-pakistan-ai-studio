...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="min-h-screen flex flex-col bg-canvas text-primary transition-colors duration-200">
        <ThemeProvider>
          <Navbar />
          ...
          {/* Footer */}
          <footer className="border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/60 mt-12 transition-colors">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2 text-xs font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/50 px-3 py-1.5 rounded-md w-fit border border-blue-200 dark:border-blue-800">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-xs text-slate-600 dark:text-slate-400">
                    <p className="flex items-center space-x-1.5">
                      <span className="px-2 py-0.5 rounded bg-blue-100 dark:bg-blue-900/60 text-blue-700 dark:text-blue-300 font-bold">JazzCash</span>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-3 text-slate-700 dark:text-slate-300 mb-2">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-900 dark:text-slate-100">+92 (021) 111-SKILL (75455)</p>
                      <p className="text-[11px] text-slate-400 dark:text-slate-500">Mon-Sat: 8:00 AM - 10:00 PM PST</p>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Email: support@skillconnect.pk</p>
                </div>
              </div>

              <div className="border-t border-slate-200 dark:border-slate-800 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 dark:text-slate-400">
