...
export default function ProviderDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {payoutNotice && (
        <div className="p-4 rounded-2xl bg-emerald-500/15 border border-emerald-500/40 text-emerald-800 dark:text-emerald-300 flex items-center justify-between text-xs font-semibold">
          <div className="flex items-center space-x-2">
            <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
            <span>{payoutNotice}</span>
          </div>
          <button onClick={() => setPayoutNotice(null)} className="text-emerald-700 dark:text-emerald-300 hover:opacity-75">
            <X className="w-4 h-4" />
          </button>
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 font-bold text-xs flex items-center space-x-1.5 hover:border-emerald-500 shadow-sm transition-colors"
          >
          ...
          <button
            ...
            className="px-3.5 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-red-500/10 text-slate-700 dark:text-slate-300 hover:text-red-500 font-bold text-xs flex items-center space-x-1.5 transition-colors"
            title="Log Out"
          >
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-900 to-emerald-950 text-white border border-slate-800 shadow-xl space-y-3">
          ...
          <div className="pt-2 flex space-x-2">
            <button
              ...
              className="px-3.5 py-1.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-slate-950 font-bold text-xs flex items-center space-x-1.5 transition-colors"
            >
